...
torch.cuda.manual_seed_all(SEED) # Для всех GPU ядер

# Вот эти две строчки сделают вычисления идентичными:
torch.backends.cudnn.deterministic = True  # Принудительный детерминизм видеокарты
torch.backends.cudnn.benchmark = True    # Запрет оптимизатору CUDA менять алгоритмы на лету
#####################################################
